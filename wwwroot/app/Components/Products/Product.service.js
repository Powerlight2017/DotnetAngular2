...
var ProductService = (function () {
    ...
    ProductService.prototype.loadDataPaged = function (skip, take) {
        var _this = this;
        return this._http.get('/api/products/getpaged?skip=' + skip + "&take=" + take)
            .toPromise()
            .then(function (response) { return _this.extractArray(response); })
            .catch(this.handleErrorPromise);
    };
    ProductService.prototype.AddOrUpdate = function (model) {
